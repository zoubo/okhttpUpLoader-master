...
public class UpLoadActivity extends AppCompatActivity implements View.OnClickListener, UploadTaskListener {
    ...
    private String url_test = "http://106.15.228.37:8613/uploadVideo";
...
//            download360();
    ...
    private void requestPermissions() {
        ...
        if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
            ...
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.READ_PHONE_STATE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 123);
            return;
        }
    }
    ...
    private void upload(){
        final int chunk = 1;
        UploadTask task = new UploadTask.Builder().setUrl(url_test).setChunck(chunk).setFileName("test.mp4").setListener(UpLoadActivity.this).build();
    ...
    private void download360() {
        ...
        OkHttpRequestUtils.getInstance(UpLoadActivity.this).OkHttpGetStringRequest(url_test, params, new StringCallback() {
            @Override
